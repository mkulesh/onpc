...
class MockupState extends State
{
    MockupState(int zone)
    {
        ...
        networkServices.put("04", new ReceiverInformationMsg.NetworkService("04", "Pandora"   ,1, false));
        networkServices.put("0A", new ReceiverInformationMsg.NetworkService("0A", "Spotify"   ,1, false));
        networkServices.put("0E", new ReceiverInformationMsg.NetworkService("0E", "TuneIn"    ,1, false));
        networkServices.put("12", new ReceiverInformationMsg.NetworkService("12", "Deezer"    ,1, false));
        networkServices.put("18", new ReceiverInformationMsg.NetworkService("18", "Airplay"   ,1, false));
        networkServices.put("1B", new ReceiverInformationMsg.NetworkService("1B", "Tidal"     ,1, false));
        networkServices.put("1D", new ReceiverInformationMsg.NetworkService("1D", "Play Queue",1, false));
