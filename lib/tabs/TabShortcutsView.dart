...
class TabShortcutsView extends UpdatableView
{
    static const List<String> UPDATE_TRIGGERS = [
        FavoriteShortcutEditDialog.SHORTCUT_CHANGE_EVENT
    ];

    TabShortcutsView(final ViewContext viewContext) : super(viewContext, UPDATE_TRIGGERS);
    ...
    Widget createView(BuildContext context, VoidCallback updateCallback)
    {
        ...
        final Widget list = ReorderableListView(
        ...
        return Column(
            ...
            children: [ Expanded(child: list, flex: 1)],
        );
    }
