    ...
    Widget createView(BuildContext context, VoidCallback updateCallback)
    {
        ...
        switch (soundControl)
        {
            case SoundControlType.DEVICE_BUTTONS:
                return UpdatableWidget(child: VolumeControlSliderView(viewContext));
            case SoundControlType.DEVICE_SLIDER:
            case SoundControlType.DEVICE_BTN_SLIDER:
                return UpdatableWidget(child: DeviceVolumeSliderView(viewContext, soundControl == SoundControlType.DEVICE_BTN_SLIDER));
